    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
      ...
      <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
        <div class="flex items-center">
          ...
          <span class="ml-1">
            {summary?.stargazers_count ?? 0} {starCountText}
          </span>
        </div>
        <div class="flex items-center">
          <svg
          ...
          >
            <title>Fork</title>
            <path d="M5.5 3.5a2 2 0 100 4h9a2 2 0 100-4h-9zM5.5 7.5a2 2 0 100 4h9a2 2 0 100-4h-9z">
            </path>
            <path
              fill-rule="evenodd"
              d="M3.5 10.5A2 2 0 015.5 8h9a2 2 0 012 2v5a2 2 0 01-2 2h-9a2 2 0 01-2-2v-5z"
              clip-rule="evenodd"
            >
            </path>
          </svg>
        ...
        <div class="flex items-center">
          ...
          <span class="ml-1">
            {summary?.watchers_count ?? 0} {watcherCountText}
          </span>
        </div>
        <div class="flex items-center">
          <svg
          ...
          <span class="ml-1">
            {summary?.open_issues_count ?? 0} {issueCountText}
          </span>
        </div>
      </div>
    </div>
